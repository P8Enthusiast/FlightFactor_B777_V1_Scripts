if (PLANE_ICAO == "B77W") or (PLANE_ICAO == "B772") or (PLANE_ICAO == "B77L") then 
	-- LNAV 
	...
	create_command("FlyWithLua/Autopilot/DISC", "Toggle A/P DISC", "Disc1()", "","")
	...
	-- FD1 OFF   Flight Director Switch 1 OFF
	function fdo()
	set("anim/34/switch", 1)
	end
	create_command("FlyWithLua/Autopilot/FDO", "Flight Director OFF", "fdo()", "","")


	-- FD1 ON   Flight Director Switch 1 ON
	function fdn()
	set("anim/34/switch", 0)
	end
	create_command("FlyWithLua/Autopilot/FDN", "Flight Director ON", "fdn()", "","")
